...
/******/ 	var hotCurrentHash = "c094a10e2495db01b815"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _game_model = __webpack_require__(301);
	
	var _game_model2 = _interopRequireDefault(_game_model);
	
	var _space_model = __webpack_require__(303);
	
	var _space_model2 = _interopRequireDefault(_space_model);
	
	var _board_model = __webpack_require__(302);
	
	var _board_model2 = _interopRequireDefault(_board_model);
	
	var _player_model = __webpack_require__(304);
	
	var _player_model2 = _interopRequireDefault(_player_model);
	
	var _game_view = __webpack_require__(306);
	
	var _game_view2 = _interopRequireDefault(_game_view);
	
	var _player_view = __webpack_require__(307);
	
	var _player_view2 = _interopRequireDefault(_player_view);
	
	var _choice_list_model = __webpack_require__(305);
	
	var _choice_list_model2 = _interopRequireDefault(_choice_list_model);
	
	var _choice_list_view = __webpack_require__(308);
	
	var _choice_list_view2 = _interopRequireDefault(_choice_list_view);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	(0, _jquery2.default)(document).ready(function () {
	
	  var game = new _game_model2.default();
	  var board = new _game_view2.default({
	    el: (0, _jquery2.default)('#game'),
	    model: game,
	    playerPersonas: game.playerPersonas
	  });
	
	  var choiceView = new _choice_list_view2.default({
	    el: (0, _jquery2.default)('#choices'),
	    model: game.playerPersonas,
	    template: _underscore2.default.template((0, _jquery2.default)('#choice-list-template').html())
	  });
	
	  var player1 = new _player_model2.default();
	  var player2 = new _player_model2.default();
	  ...
	  var p1 = new _player_view2.default({
	    el: (0, _jquery2.default)('#player-list'),
	    template: _underscore2.default.template((0, _jquery2.default)('#player-list-template').html()),
	    player1: player1,
	    player2: player2
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(300), __webpack_require__(298), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Game = _backbone2.default.Model.extend({
	  ...
	  initialize: function initialize() {
	    this.board = new _board_model2.default();
	    this.board.parent = this;
	    this.playerPersonas = new _choice_list_model2.default();
	    this.playerPersonas.parent = this;
	    this.playCounter = 0;
	    return this;
	  },
	
	  addPlayers: function addPlayers(player1) {
	  ...
	  setWinStatus: function setWinStatus(status) {
	    this.set('winStatus', status);
	  },
	
	  checkWinStatus: function checkWinStatus(row, col, mark) {
	  ...
	  returnWinStatus: function returnWinStatus() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Board = _backbone2.default.Model.extend({
	  ...
	  diagonalPossibilities: ['row0col0', 'row0col2', 'row1col1', 'row2col0', 'row2col2'],
	
	  makeRow: function makeRow() {
	    var row = [];
	
	    for (var i = 0; i < 3; i++) {
	      var space = new _space_model2.default();
	      row.push(space);
	    }
	    return row;
	  },
	
	  makeAllSpaces: function makeAllSpaces() {
	    var grid = [];
	    for (var i = 0; i < 3; i++) {
	  ...
	  returnLeftDiagonal: function returnLeftDiagonal() {
	    var leftD = [];
	  ...
	  returnRightDiagonal: function returnRightDiagonal() {
	    var rightD = [];
	  ...
	  returnRow: function returnRow(rowNumber) {
	    var that = this;
	    var row = [];
	    for (var i = 0; i < 3; i++) {
	  ...
	  returnCol: function returnCol(colNumber) {
	    var that = this;
	    var col = [];
	    for (var i = 0; i < 3; i++) {
	  ...
	  reportEvery: function reportEvery(line, val) {
	    return line.every(function (lineVal) {
	      return val === lineVal;
	    });
	  },
	
	
	  reportMatch: function reportMatch(num, type, val) {
	    var test;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Space = _backbone2.default.Model.extend({
	  ...
	  setMark: function setMark(playerMark) {
	    this.set("mark", playerMark);
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Player = _backbone2.default.Model.extend({
	  ...
	  reportNameChange: function reportNameChange() {
	  ...
	  playSpace: function playSpace(space) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChoiceList = _backbone2.default.Model.extend({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GameView = _backbone2.default.View.extend({
	  el: (0, _jquery2.default)('#game'),
	  template: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"hbs!./../templates/board\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
	  ...
	  play: function play(event) {
	    ...
	    if (player.mark != undefined) {
	      if (this.model.returnWinStatus() != 'in progress') {
	        ...
	        if ((0, _jquery2.default)(event.currentTarget).has('.mark').length) {
	  ...
	  markSquare: function markSquare(input) {
	    var squareElement = '#' + input;
	    var markImage = (0, _jquery2.default)('<img></img>');
	    var markDiv = (0, _jquery2.default)('<div></div>');
	    markImage.attr('src', this.model.currentPlayer.mark);
	    markDiv.addClass('mark').append(markImage);
	    (0, _jquery2.default)(squareElement).append(markDiv);
	    this.fillSquare('div.mark', 'img');
	  },
	
	  fillSquare: function fillSquare(container, item) {
	    var fillClass = (0, _jquery2.default)(container).height() > (0, _jquery2.default)(container).width() ? 'fillheight' : 'fillwidth';
	    (0, _jquery2.default)(container).find(item).addClass(fillClass);
	  },
	
	  tallyMark: function tallyMark(row, col, mark) {
	  ...
	  checkWin: function checkWin(row, col, mark) {
	  ...
	  showWinStatus: function showWinStatus(image) {
	    var win = (0, _jquery2.default)('<img></img>');
	    win.attr('class', 'overlay').attr('src', image);
	    (0, _jquery2.default)('#row2').append(win);
	  },
	
	  proclaimWinner: function proclaimWinner() {
	    this.model.setWinner(this.model.currentPlayer);
	    this.highlightWinner(this.model.currentPlayer);
	  },
	
	  highlightWinner: function highlightWinner(winner) {
	    if (winner == this.model.player1) {
	      (0, _jquery2.default)('#player1').addClass('winner');
	    } else {
	      (0, _jquery2.default)('#player2').addClass('winner');
	    }
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChoiceListView = _backbone2.default.View.extend({
	  ...
	  addLogo: function addLogo() {
	    ...
	    var logoDestination = (0, _jquery2.default)('<li></li>');
	    logoDestination.append(logoImage);
	    this.el.append(logoDestination);
	  },
	
	  listChoices: function listChoices() {
	    var that = this;
	    ...
	    for (var choice in choices) {
	      ...
	      var choiceDestination = (0, _jquery2.default)('<li></li>');
	  ...
	  constructImage: function constructImage(id, mark, name) {
	    var choiceImage = (0, _jquery2.default)('<img></img>');
	    choiceImage.attr('id', id).attr('src', mark).attr('alt', 'Image of ' + name).attr('title', name);
	    return choiceImage;
	  },
	
	  promptPickCharacter: function promptPickCharacter(player) {
	  ...
	  addPrompt: function addPrompt() {
	    ...
	    (0, _jquery2.default)('#prompt').html(prompt);
	  },
	
	  pickCharacter: function pickCharacter(event) {
	    ...
	    if (this.validatePlayer(this.model.parent.currentPlayer)) {
	      ...
	      if (this.validatePick(event)) {
	        ...
	        (0, _jquery2.default)(event.target).addClass('picked');
	        prompt.hide();
	  ...
	  validatePick: function validatePick(event) {
	    var promptText;
	    if (event.target.id == 'logo' || (0, _jquery2.default)(event.currentTarget).hasClass('picked')) {
	      return false;
	    }
	    return true;
	  },
	
	  validatePlayer: function validatePlayer(player) {
	    if (player.get('name') == '?') {
	      return true;
	    }
	    return false;
	  ...
	  highlightHover: function highlightHover(event) {
	    (0, _jquery2.default)(event.target).addClass('maybeChoose');
	  },
	
	  removeHoverEffect: function removeHoverEffect(event) {
	    (0, _jquery2.default)(event.target).removeClass('maybeChoose');
	  },
	...
	exports.default = ChoiceListView;
